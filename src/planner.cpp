...
//   collision_detection_ptr_.reset(new CollisionDetection(param_manager_->GetCollsionDetectionParams()));
...
//     //TODO make these vector3d in future
//     const Eigen::Vector2d goal(x, y);
//     // __________
//     // DEBUG GOAL
...
//     t = Helper::normalizeHeadingRad(t);
//     //TODO make these vector3d in future
//     const Eigen::Vector2d start(x, y);
//     // ___________
//     // DEBUG START
